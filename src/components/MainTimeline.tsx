...
const MainTimeline = () => {
  return (
    <main className="ml-[275px] flex max-w-[600px] h-full min-h-screen flex-col border-l-[0.5px] border-r-[0.5px] 
    border-gray-600">
            ...
            <div key={i} className="border-b-[0.5px] border-gray-600 p-2 flex space-x-4">
              ...
              <div className="flex flex-col">
                <div className="flex items-center w-full justify-between">
                  ...
                  <div className="font-bold">Destiny 2</div>
                    <div className="text-gray-500">@DestinyTheGame</div>
                    <div className="text-gray-500">
                      <BsDot />
                    </div>
                    <div className="text-gray-500">14h</div>
                  </div>
                  <div>
                    <BsThreeDots />
                  </div>
